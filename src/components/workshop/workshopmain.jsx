        ...
        <>
            <section className="py-5 d-flex justify-content-center align-items-center">
                <main className="container">
                    <div className="row">
                        <div className="col-lg-6 mb-4 mb-lg-0  py-2">
                            <h1 className="fw-bold px-3 w-100">
                                OUR <b className="text-light">WORKSHOPS</b>
                            </h1>
                            <h3 className="w-100 px-3 py-3 fw-bold text-light">
                                India's First Passionpreneur Mentor, Best Selling Author - <b className="text-dark">10% Theory + 90% Practical</b>
                            </h3>
