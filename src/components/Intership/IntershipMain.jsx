    ...
    <div>
      ...
      <section className="container">
        <main className='row d-flex py-5 gap-5'>
          <div className="col w-50 px-5 ">
            <h1 className='fw-bold py-3' style={{ color: "skyblue" }}>Bright InfoTech <b className='text-white'>Intership Programs</b> </h1>
            <p className='text-light fs-5'>Join our internship program today and start your journey towards a successful career in the software industry!</p>
            <div className='pt-5'>
          ...
          <div className="col d-flex justify-content-center">
            <img src="./img/internshiplogo1.png" alt="" width={450} />
          </div>
        </main>
