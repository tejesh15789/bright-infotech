                ...
                <div className="container bgc-gray-size">
                    ...
                    <div className="collapse navbar-collapse" id="navbarText">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 px-2 gap-4 text-decoration-none color">
                            ...
                            <li className="nav-item"><Link to="/Services" className="text-decoration-none" onClick={handleLinkClick}>SoftWareTraining</Link></li>
                            <li className="nav-item"><Link to="/Placed Students" className="text-decoration-none" onClick={handleLinkClick}>PlacedStudents</Link></li>
                            <li className="nav-item"><Link to="/Intership" className="text-decoration-none" onClick={handleLinkClick}>Intership</Link></li>
                            <li className="nav-item"><Link to="/Hiring Partners" className="text-decoration-none" onClick={handleLinkClick}>HiringPartners</Link></li>
