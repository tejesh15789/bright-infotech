                        ...
                        <main className="usefull">
                            ...
                            <div>
                                <ul className='text-gray usefull-link'>
                                    ...
                                    <li><Link to="/termsandpolices" className='text-gray'>Terms of Condition</Link></li>
                                    <li><Link to="/Privatepolicy" className='text-gray'>Privacy policy</Link></li>
                                    <li><Link to="/Policyreturn" className='text-gray'>Return and Refund Policy</Link></li>
                                </ul>
                            </div>
                            <div></div>
                        </main>
