        ...
        <div className='d-flex justify-content-center align-items-center py-4'>
            <section className='container row py-4'>
                <div className="col">
                    ...
                    <div className="d-flex  gap-3 h-auto py-3">
                        {Durationtime.map((val) => (
                            <div className=" services-three gx-5 gap-2" key={val.id}>
                                ...
                                <div className="d-flex justify-content-center align-items-center px-3">
                                    <img src={val.logo} alt={val.title} style={{ height: '20px', width:'20px', objectFit: 'contain'  }}
                                        className='' />
                                    <span className=' fs-6 fw-bolder text-center'>{val.desc}</span>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="mb-2 mt-2">
                        <Button variant="light" size="lg" className="fw-bold col-md-12 col-12">
                            Download Brochure <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48" className="filelogo">
                ...
                <div className="col py-5 d-flex justify-content-center align-items-center">
                    <img src="./img/services.png" alt="" width={400} height={300} />
                </div>
            </section>
        </div>
    );
